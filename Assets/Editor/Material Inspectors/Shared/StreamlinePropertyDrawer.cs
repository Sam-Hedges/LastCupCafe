...
public static class StreamlinePropertyDrawer {
    public static void DrawProperties(MaterialProperty[] properties, MaterialEditor editor, StreamlineDrawers drawers,
                                      DefaultDrawer defaultDraw) {
        var foldoutCount = 0;
        var material = editor.target as Material;

        if (material == null) {
            EditorGUILayout.HelpBox("[Streamline] Material is null", MessageType.Error);
            return;
        }
